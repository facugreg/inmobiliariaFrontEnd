...
export default function FormCrearInmueble() {
  ...
  return (
    <CCard className="p-3 w-100 bg-light">
      <CCardBody>
        <CCardTitle>Nuevo Inmueble</CCardTitle>
        <CForm onSubmit={handleSubmit} className="mt-3">
          ...
          <CRow>
            <CFormLabel htmlFor="mtrs">Metros*</CFormLabel>
            <CFormInput
              type="number"
              id="mtrs"
              name="mtrs"
          ...
          <CRow>
            <CFormLabel htmlFor="precioDolar">
              Precio según tipo de servicio (mensual, cuatrimestral, anual o
              total)*
            </CFormLabel>
            <CFormInput
              type="number"
          ...
          <CRow>
            <CFormLabel htmlFor="direccionCalle">Calle*</CFormLabel>
            <CFormInput
              type="text"
              name="direccionCalle"
              id="direccionCalle"
          ...
          <CRow>
            <CFormLabel htmlFor="direccionNumero">Número*</CFormLabel>
            <CFormInput
              type="number"
          ...
          <CRow>
            ...
            >
              ...
              {opcionesLocalidades.map((opcion) => (
                <option key={opcion.value} value={opcion.value}>
                  {opcion.label}
                </option>
              ))}
          ...
          {formData.tipo === 'departamento' && (
            <>
              ...
              <CRow>
                <CFormLabel htmlFor="depto">
                  Número o sección de departamento
                </CFormLabel>
                <CFormInput
                  type="text"
                  id="depto"
              ...
              <CRow>
                <CFormLabel htmlFor="cantAmbientes">
        ...
        <CModal visible={showModal} onClose={handleCloseModal}>
          ...
          <CModalBody>
            <p>
              <strong>{formData?.tipo}</strong> guardado/a
            </p>
          </CModalBody>
          <CModalFooter>
